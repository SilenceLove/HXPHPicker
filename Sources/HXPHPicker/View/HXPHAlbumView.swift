...
protocol HXPHAlbumViewDelegate: NSObjectProtocol {
    func albumView(_ albumView: HXPHAlbumView, didSelectRowAt assetCollection: HXPHAssetCollection)
}

class HXPHAlbumView: UIView, UITableViewDataSource, UITableViewDelegate {
    
    weak var delegate: HXPHAlbumViewDelegate?
    ...
    lazy var tableView : UITableView = {
        ...
        if let customCellClass = config.customCellClass {
            ...
            tableView.register(HXPHAlbumViewCell.self, forCellReuseIdentifier: "AlbumViewCellID")
        }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "AlbumViewCellID") as! HXPHAlbumViewCell
    ...
    func tableView(_ tableView: UITableView, didEndDisplaying cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        let myCell: HXPHAlbumViewCell = cell as! HXPHAlbumViewCell
