...
@objc protocol HXPHPickerBottomViewDelegate: NSObjectProtocol {
    @objc optional func bottomView(didPreviewButtonClick bottomView: HXPHPickerBottomView)
    @objc optional func bottomView(didEditButtonClick bottomView: HXPHPickerBottomView)
    @objc optional func bottomView(didFinishButtonClick bottomView: HXPHPickerBottomView)
    @objc optional func bottomView(_ bottomView: HXPHPickerBottomView, didOriginalButtonClick isOriginal: Bool)
