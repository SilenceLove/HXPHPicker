...
@objc public protocol PhotoPickerViewCellDelegate: NSObjectProtocol {
    @objc optional func cell(_ cell: PhotoPickerBaseViewCell, didSelectControl isSelected: Bool)
}
