...
open class HXPHPickerConfiguration: HXPHConfiguration {
    
    /// 选择的类型，控制获取系统相册资源的类型
    public var selectType : HXPHPickerSelectType = .any
    
    /// 选择模式
    public var selectMode: HXPHPickerSelectMode = .multiple
    ...
    /// 相册展示模式
    public var albumShowMode: HXPHPickerAlbumShowMode = .normal
