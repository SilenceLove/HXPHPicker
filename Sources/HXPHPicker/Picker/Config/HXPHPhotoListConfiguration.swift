...
public class HXPHPhotoListConfiguration: NSObject {
    /// 相册标题视图配置
    public lazy var titleViewConfig: HXPHAlbumTitleViewConfiguration = {
        let titleViewConfig = HXPHAlbumTitleViewConfiguration.init()
    ...
    /// 取消按钮类型
    public var cancelType: HXPHPickerViewController.CancelType = .text
    
    /// 取消按钮位置
    public var cancelPosition: HXPHPickerViewController.CancelPosition = .right
