...
enum HXPHPickerViewControllerSwipeSelectState {
    case select
    case unselect
}
...
public class HXPHPickerViewController: UIViewController {
    ...
    lazy var titleView: HXPHAlbumTitleView = {
        let titleView = HXPHAlbumTitleView.init(config: config.titleViewConfig)
    ...
    lazy var albumView: HXPHAlbumView = {
        let albumView = HXPHAlbumView.init(config: pickerController!.config.albumList)
...
extension HXPHPickerViewController {
    ...
    @objc func didTitleViewClick(control: HXPHAlbumTitleView) {
...
// MARK: HXPHAlbumViewDelegate
extension HXPHPickerViewController: HXPHAlbumViewDelegate {
    
    func albumView(_ albumView: HXPHAlbumView, didSelectRowAt assetCollection: HXPHAssetCollection) {
...
extension HXPHPickerViewController: HXPHPickerBottomViewDelegate {
    ...
    func bottomView(didPreviewButtonClick bottomView: HXPHPickerBottomView) {
    ...
    func bottomView(_ bottomView: HXPHPickerBottomView, didOriginalButtonClick isOriginal: Bool) {
