...
public class HXPHAlbumViewController: HXPHViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    lazy var tableView : UITableView = {
        ...
        tableView.register(HXPHAlbumViewCell.self, forCellReuseIdentifier: "cellId")
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cellId") as! HXPHAlbumViewCell
