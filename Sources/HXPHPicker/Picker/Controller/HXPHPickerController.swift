...
@objc public protocol HXPHPickerControllerDelegate: NSObjectProtocol {
    ...
    /// - Parameters:
    ///   - pickerController: 对应的 HXPHPickerController
    ///   - viewController: 对应的控制器 [HXPHAlbumViewController, HXPHPickerViewController, HXPHPreviewViewController]
    @objc optional func pickerController(_ pickerController: HXPHPickerController, viewControllersWillAppear viewController: UIViewController)
    
    /// 视图控制器已经显示
    @objc optional func pickerController(_ pickerController: HXPHPickerController, viewControllersDidAppear viewController: UIViewController)
    
    /// 视图控制器即将消失
    @objc optional func pickerController(_ pickerController: HXPHPickerController, viewControllersWillDisappear viewController: UIViewController)
    
    /// 视图控制器已经消失
    @objc optional func pickerController(_ pickerController: HXPHPickerController, viewControllersDidDisappear viewController: UIViewController)
...
open class HXPHPickerController: UINavigationController {
    ...
    /// 相册列表控制器
    public func albumViewController() -> HXPHAlbumViewController? {
        return getViewController(for: HXPHAlbumViewController.self) as? HXPHAlbumViewController
    }
    /// 照片选择控制器
    ...
    public convenience init(picker config: HXPHPickerConfiguration) {
    ...
    private var selectType : HXPHPickerSelectType?
