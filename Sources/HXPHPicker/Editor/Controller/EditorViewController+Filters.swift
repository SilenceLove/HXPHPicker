            ...
            if filter.isOriginal {
                ...
                if filterEditFator.isApply {
                    ...
                    operation.addExecutionBlock { [unowned operation] in
                        ...
                        if let image = originalImage?.hx.ci_Image?.apply(self.filterEditFator),
                ...
                if let image = originalImage {
                    ...
                    if let mosaicImage = selectedMosaicImage {
                        ...
                        operation.addExecutionBlock { [unowned operation] in
                            if operation.isCancelled { return }
                            if let mosaic_Image = image.hx.ci_Image?.applyMosaic(level: self.config.mosaic.mosaicWidth) {
