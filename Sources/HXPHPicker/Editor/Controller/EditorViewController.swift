...
//            delegate?.editorViewController(self, didFinish: [])
    ...
    func imageFilterProcessing(completion: @escaping (ImageEditedResult?) -> Void) {
        ...
        PhotoTools.getImageData(image, queueLabel: "hxphpicker.editor.ImageFilterProcessingQueue") {
            ...
            PhotoTools.compressImageData(
                ...
                queueLabel: "hxphpicker.editor.CompressImageFilterProcessingQueue"
            ) {
                ...
                PhotoTools.compressImageData(
                    ...
                    queueLabel: "hxphpicker.editor.CompressThumbImageFilterProcessingQueue"
                ) { thumbData in
