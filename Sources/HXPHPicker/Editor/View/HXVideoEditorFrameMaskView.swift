//
//  HXVideoEditorFrameMaskView.swift
//  HXPHPicker
//
...
protocol HXVideoEditorFrameMaskViewDelegate: NSObjectProtocol {
...
class HXVideoEditorFrameMaskView: UIView {
    let imageWidth: CGFloat = 8
    var validRectX: CGFloat {
        30 + UIDevice.leftMargin
    }
    
    weak var delegate: HXVideoEditorFrameMaskViewDelegate?
