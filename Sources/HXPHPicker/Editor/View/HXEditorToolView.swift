...
protocol HXEditorToolViewDelegate: NSObjectProtocol {
...
class HXEditorToolView: UIView {
    weak var delegate: HXEditorToolViewDelegate?
    var config: HXEditorToolViewConfiguration
    ...
    lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(HXEditorToolViewCell.self, forCellWithReuseIdentifier: "HXEditorToolViewCellID")
    ...
    init(config: HXEditorToolViewConfiguration) {
        self.config = config
...
extension HXEditorToolView: UICollectionViewDataSource, UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        config.toolModelArray.count
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "HXEditorToolViewCellID", for: indexPath) as! HXEditorToolViewCell
